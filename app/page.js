          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              <div className="hero-two-left mb-90 rmb-60">
                ...
                >
                  <p>
                    Las mejores Pizzas congeladas 🍕❄️🇨🇷
                    Artesanales 👨‍🍳
                    Entrega a domicilio🏠
                    Pedidos al 8769 7993 
                  </p>
      ...
      <div className="headline-area pt-70 rel z-1">
        <span className="marquee-wrap">
          <span className="marquee-inner left">
            <span className="marquee-item">Pizza Congelada</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
            <span className="marquee-item">Panninis</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
            <span className="marquee-item">Foccacia</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
          </span>
          <span className="marquee-inner left">
            <span className="marquee-item">Desayuno</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
            <span className="marquee-item">Ingredientes frescos</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
            <span className="marquee-item">Pizza Italiana</span>
            <span className="marquee-item">
              <i className="flaticon-star" />
            </span>
          </span>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-6 col-lg-8">
              <div
                ...
                data-aos-offset={50}
              >
                <span className="sub-title mb-5">Categoria de Comida</span>
                <h2>
                  Tenemo muchas opciones &amp; de calidad y saludables
                </h2>
              </div>
            </div>
          </div>
